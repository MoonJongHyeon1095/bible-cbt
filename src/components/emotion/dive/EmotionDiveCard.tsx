...
//               <button
//                 type="button"
//                 className="mt-1 flex h-6 w-6 items-center justify-center rounded-full border border-gray-200 text-[10px] hover:bg-gray-50 dark:border-neutral-700 dark:bg-neutral-900 dark:text-gray-100 dark:hover:bg-neutral-800"
//                 onClick={() => onChooseSuggestion(s.belief)} // 🔴 belief만 노드 값으로 저장
//               >
//                 ↓
//               </button>
//             </div>
...
type EmotionDiveCardProps = {
  ...
  emotionContext?: EmotionContext;
  onDiveFromInput: (text: string) => void;
  // 🔹 belief + emotionReason 둘 다 위로 올림
